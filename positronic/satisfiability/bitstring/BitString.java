...
public class BitString implements IBitString
{
	...
	public BitString(String name, boolean[] data) throws Exception
	{
		...
		for(int i=0;i<data.length;i++)
			this.setBooleanVariable(i,BooleanVariable.getBooleanVariable(name+DELIMITER+i,data[i]));
	}
	...
	public BitString(String name, char[] data) throws Exception
	{
		...
		for(int i=0;i<data.length;i++)
		{
			...
			if(data[i]=='0')
				this.setBooleanVariable(i,BooleanVariable.getBooleanVariable(name+DELIMITER+i,false));
			if(data[i]=='1')
				this.setBooleanVariable(i,BooleanVariable.getBooleanVariable(name+DELIMITER+i,true));
		}
	}
	...
	public BitString(String name, IBooleanVariable[] data) throws Exception
	{
		...
		for(int i=0;i<data.length;i++)
		{
			...
			this.setBooleanVariable(i,BooleanVariable.getBooleanVariable(name+DELIMITER+i,data[i].getValue()));
		}
	}
	...
	{
		return (List<IBooleanVariable>)this.data;
	}
  ...
  {
    return (IBooleanVariable[])this.asList().toArray(new IBooleanVariable[0]);
  }*/
	...
	public void setBooleanVariable(int i, IBooleanVariable ib) throws Exception
	{
		...
		while(a.size()<=i)
			a.add(BooleanVariable.getBooleanVariable(this.getName()+DELIMITER+i));
		a.set(i,ib);
	}

	/*public void setDataList(List a) throws Exception
  {
  	if(a==null)
    	throw new BitStringException("Passed null List to setDataList method.");
