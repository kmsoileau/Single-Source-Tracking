...
{
	private static final long serialVersionUID = 3948860233178176756L;
	...
	{
		return (List<IBooleanVariable>)this;
	}
	...
	public boolean equals(Object anObject)
	{
		...
		if(!this.asList().containsAll(extracted(anObject)))
			return false;
		if(!(extracted(anObject)).containsAll((List<IBooleanVariable>)this))
			return false;
		return true;
	}
	...
	public IBooleanVariable getBooleanVariable(int i) throws Exception
	{
		...
		return (IBooleanVariable)this.get(i);
	}
