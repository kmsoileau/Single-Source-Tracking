...
public class BitStringTable implements IBitStringTable
{
  ...
  {
    this("BitStringList$"+ bSTCount++,(IBitString[])list.toArray(new IBitString[0]));
  }
  ...
  public boolean add(IBitString o)
  {
	  ...
	  try
	  {
		  return this.getData().add((IBitString)o);
	  } 
	  catch (Exception e)
	  {
		  e.printStackTrace();
  ...
  public void add(int n, IBitString o)
  {
    try
	{
		...
		this.getData().add(n,(IBitString)o);
	} catch (Exception e)
	{
		e.printStackTrace();
	}
  ...
  public boolean addAll(int n,Collection<IBitString> c)
  {
    try
	{
		return ((ArrayListSet<IBitString>)this.getData()).addAll(n,c);
	} catch (Exception e)
	{
		e.printStackTrace();
		return false;
  ...
  public Object clone() throws CloneNotSupportedException
  {
    try
    {
      return new BitStringTable(this.getName(),(IBitString[])this.getData().toArray(new IBitString[0]));
    }
  ...
  public IBitString get(int n)
  {
    try
	{
		return ((ArrayListSet<IBitString>)this.getData()).get(n);
	} catch (Exception e)
	{
		e.printStackTrace();
		return null;
  ...
  public IBitString getBitString(int i) throws Exception
  {
    ...
    return (((ArrayListSet<IBitString>)this.getData()).get(i));
  }
  ...
  public int indexOf(Object o)
  {
    try
	{
		return ((ArrayListSet<IBitString>)this.getData()).indexOf(o);
	} catch (Exception e)
	{
		e.printStackTrace();
		return -1;
  ...
  public int lastIndexOf(Object o)
  {
    try
	{
		return ((ArrayListSet<IBitString>)this.getData()).lastIndexOf(o);
	} catch (Exception e)
	{
		e.printStackTrace();
		return -1;
  ...
  public ListIterator<IBitString> listIterator()
  {
    try
	{
		return ((ArrayListSet<IBitString>)this.getData()).listIterator();
	} catch (Exception e)
	{
		e.printStackTrace();
		return null;
  ...
  public ListIterator<IBitString> listIterator(int n)
  {
    try
	{
		return ((ArrayListSet<IBitString>)this.getData()).listIterator(n);
	} catch (Exception e)
	{
		e.printStackTrace();
		return null;
  ...
  public IBitString remove(int n)
  {
    try
	{
		return ((ArrayListSet<IBitString>)this.getData()).remove(n);
	} catch (Exception e)
	{
		e.printStackTrace();
		return null;
  ...
  public IBitString set(int n, IBitString o)
  {
    ...
    try
	{
		...
		return this.getData().set(n,(IBitString)o);
	} catch (Exception e)
	{
		e.printStackTrace();
		return null;
  ...
  public void setBitString(int i,IBitString bitString) throws Exception
  {
  	...
  	((ArrayListSet<IBitString>)this.getData()).set(i,bitString);
  }
  ...
  public List<IBitString> subList(int m, int n)
  {
    try
	{
		return ((ArrayListSet<IBitString>)this.getData()).subList(m,n);
	} 
    catch (Exception e)
	{
		e.printStackTrace();
  ...
  {
    return (ArrayListSet<IBitString>)this.listData;
  }
