...
/*
 * ConditionalAdder is satisfied when INaturalNumber conditionalSum is the vector dot product of 
 * INaturalNumber[] numbers and IBooleanVariable[] membership.
 */
public class ConditionalAdder extends Problem implements IProblem
{
	...
	public ConditionalAdder(INaturalNumber[] numbers, IBooleanVariable[] membership, 
