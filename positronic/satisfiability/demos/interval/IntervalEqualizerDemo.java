...
import positronic.satisfiability.interval.IntervalEqualizer;
import positronic.satisfiability.interval.IntervalFixer;
import positronic.satisfiability.naturalnumber.NaturalNumber;

public class IntervalEqualizerDemo 
{
  public static void main(String[] args) throws Exception
  {
    ...
    Interval interval2=new Interval(
    		new NaturalNumber("X2",2L),
    		new NaturalNumber("Y2",23L));
    ...
    IProblem problem=new Conjunction(N1,N2,
    		new IntervalEqualizer(interval1,interval2));
