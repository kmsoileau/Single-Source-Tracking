...
import positronic.satisfiability.bitstringlookuptable.BitStringLookupTableEntryer;
...
public class BitStringLookupTableEntryerDemo 
{
	public static void main(String[] args) throws Exception
	{
		...
		IProblem problem=new Conjunction(
    				...
    				new BitStringLookupTableEntryer(Y,table),
    			new BitStringFixer(Y,"1011")
    		);
