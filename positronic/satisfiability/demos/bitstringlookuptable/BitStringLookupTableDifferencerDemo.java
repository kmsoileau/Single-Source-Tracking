...
import positronic.satisfiability.bitstringlookuptable.BitStringLookupTableDifferencer;
...
public class BitStringLookupTableDifferencerDemo 
{
	public static void main(String[] args) throws Exception
	{
		IBitStringLookupTable table1=new BitStringLookupTable("table1",3,4);
		IBitStringLookupTable table2=new BitStringLookupTable("table1",3,4);
		...
		IProblem problem=new Conjunction(
    		...
    		new BitStringLookupTableFixer(table2,
    				...
    				new String[]{"1011","1011","0101"}),
    		new BitStringLookupTableDifferencer(X,Y,table1,table2)
    	);
		...
		if(s!=null && s.size()>0)
		{
			...
			for(int i=0;i<table2.getLength();i++)
