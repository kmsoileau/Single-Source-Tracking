...
import positronic.satisfiability.naturalnumber.NaturalNumberShiftRight;

public class NaturalNumberShiftRightDemo
{
  public static void main(String[] args) throws Exception
  {
    ...
    NaturalNumberShiftRight ShiftRight1 = new NaturalNumberShiftRight(X,Z);
