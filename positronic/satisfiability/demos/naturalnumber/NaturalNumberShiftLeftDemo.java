...
import positronic.satisfiability.naturalnumber.NaturalNumberShiftLeft;

public class NaturalNumberShiftLeftDemo
{
  public static void main(String[] args) throws Exception
  {
    ...
    NaturalNumberShiftLeft ShiftLeft1 = new NaturalNumberShiftLeft(X,Z);
