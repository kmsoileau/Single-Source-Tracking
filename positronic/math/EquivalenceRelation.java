...
public class EquivalenceRelation extends HashMap<Object,Set<Object>>
{
	...
	public static EquivalenceRelation intersect(
  		EquivalenceRelation rel1,
  		EquivalenceRelation rel2)
	{
		return EquivalenceRelation.intersect(new EquivalenceRelation[]{rel1,rel2});
	}
	...
	{
		return EquivalenceRelation.intersect(
  			new EquivalenceRelation[]{rel1,rel2,rel3});
	}
	...
	/*public static void main(String[] args)
	{
		EquivalenceRelation polygon1 = new EquivalenceRelation();
		EquivalenceRelation polygon2 = new EquivalenceRelation();
...
*/
	...
	public void add(Object object1, Object object2)
	{
	    ...
	    while(i1.hasNext())
	    {
	      ...
	      while(i2.hasNext())
	      {
	        ...
	        equivalenceClassClone.addAll((HashSet<Object>)(super.get(i2.next())));
	...
	*/
	...
	public String toString()
	{
		...
		{
			Object key=it.next();
			res+=key+"\t->\t"+(HashSet<Object>)(super.get(key))+"\n";
		}
		return res;
	}
}