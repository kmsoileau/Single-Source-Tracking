...
{	
	...
	public Ingot m_Incumbent;
	public Ingot m_Candidate;
	public Ingot m_BestIngot;

	public Annealer()
	{
		Vector<Ingot> theIngots=new Vector<Ingot>();
		m_Incumbent=new Ingot();
		theIngots.addElement(m_Incumbent);
		
		m_Candidate=new Ingot();
		theIngots.addElement(m_Candidate);

		m_BestIngot=new Ingot();
		theIngots.addElement(m_BestIngot);
	
		MyFurnace=new Furnace();
		Tricorder= new DataRecorder();
		MyAnnealist=new Annealist();
		MyAnnealist.initialTemperature(100.0);
